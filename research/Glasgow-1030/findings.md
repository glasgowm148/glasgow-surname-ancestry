# Findings: [John Glasgow (Glasgow-1030), born 1575, Glasgow, Lanarkshire, Scotland](https://www.wikitree.com/wiki/Glasgow-1030)
...
Father assessment: [William Glasgow (about 1540)](https://www.wikitree.com/wiki/Glasgow-3522)
is **uncertain and no longer the leading reconstruction**. The profile's stated
reason for the attachment is contradicted by direct records: the two men who
witnessed John's son's 1619 baptism were not brothers. George was the proved
...
or inherited property. Retain the current relationship as uncertain unless the
record-defined John is created and the identity question is resolved; do not
merge the men on this evidence alone.
...
| Person | Treatment |
| --- | --- |
| [William Glasgow (about 1540), Glasgow-3522](https://www.wikitree.com/wiki/Glasgow-3522) | Current father; mark uncertain. The 1619 witnesses do not prove this parentage. |
...
Live profile checked **19 July 2026**. Remove the statements that George and
Robert were John's known brothers and that their witness roles establish John
as William and Margaret's son. Replace them with the extended-network analysis
above. Correct the prose links from `Glasgow-1098`/`Herbesoun-1` to the attached
`Glasgow-3522`/`Herbison-439`, while marking that parent pair uncertain.

### Additional 1634 child correction — 27 July 2026

Remove [Euphame Glasgow/Glasfoord (Glasgow-1167)](https://www.wikitree.com/wiki/Glasgow-1167)
from the biography's child list pending the original image. The cited 1634
index entry is at Edinburgh and is also used for Euphame's placement in Rev.
John Glassford and Jonet Morriel's otherwise coherent Edinburgh family. It
cannot support both fathers. The Edinburgh parish and sibling context currently
