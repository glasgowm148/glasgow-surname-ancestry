# Findings: [James Glasgow (Glasgow-3305), born 1740, Moneymore, County Londonderry, Ireland](https://www.wikitree.com/wiki/Glasgow-3305)
...
birth, Moneymore residence, attached parents and reported decision to remain in
Ireland are copied from the biography of Robert Glasgow `Glasgow-12`, not from
an Irish record. He cannot presently serve as the bridge between the
Virginia/Ohio emigrant siblings and the Inishrush family.

The proposed equation with a James Glasgow called nephew in a 1766 Hawthorne
will abstract is unproved. The profile does not cite or reproduce the abstract,
identify the exact testator residence reliably, or show how that nephew is
...
| --- | --- | --- |
| [Live WikiTree profile](https://www.wikitree.com/wiki/Glasgow-3305), captured 21 July 2026 | Biography gives no evidence URL and lists only “From the text of Robert Glasgow.” No spouse, child, occupation, death or independent event is supplied. | Record identity is not established. |
| [Robert Glasgow profile](https://www.wikitree.com/wiki/Glasgow-12) | Robert's biography asserts siblings James, John, Joseph, Arthur and Mary and says all except James emigrated in 1769. The statement has no inline source. | This is the sole visible basis for James-3305; it is a tree assertion, not proof. |
| David Faris, *The Glasgow Family of Adams County, Ohio* (1990), [WorldCat summary](https://search.worldcat.org/title/22731567) | Public summary says Robert, son of James of Moneymore, emigrated with three brothers and one sister. It does not name those siblings or say another James remained in Ireland. | Supports a reported emigrant sibling group but does not support this profile's identity. |
| Profile's 1766 Hawthorne-will theory | A James Glasgow is reportedly called a nephew, but no image, archive reference or complete abstract is cited and no identifier joins him to Moneymore. | Unverified clue only; cannot support parents or residence. |
