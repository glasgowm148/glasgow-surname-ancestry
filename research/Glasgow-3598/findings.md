# Findings: [Margaret Glasgow (Glasgow-3598), born 1592, Edinburgh, Scotland](https://www.wikitree.com/wiki/Glasgow-3598)
...
| --- | --- | --- |
| 1611 FamilySearch marriage index cited in the [captured WikiTree profile](https://www.wikitree.com/wiki/Glasgow-3598) | The index identifies Margaret Glasgow as William Hardie's spouse but names no parents. | Direct marriage evidence, negative for parentage. |
| Henry Paton, ed., *The Register of Marriages for the Parish of Edinburgh, 1595-1700*, printed p. 267, [16 July 1611](https://www.tradeshouselibrary.org/uploads/4/7/7/2/47723681/register_of_marriages_for_the_parish_of_edinburgh_1595-1700_~_1898.pdf#page=277); [local extract](../../surname-research/pre-1700/sources/edinburgh_marriage_register_glasgow_extract.txt) | Margaret Glasgow married William Hardie, cordiner. The same surname page records Barbara Glasgow marrying cordiner George Johnstoun in 1616 and Isobel Glasgow marrying tailor William Symountoun in 1619. | Direct spouse, date and husband's occupation evidence. The concentrated craft-marriage cluster is a useful sibling/cousin hypothesis, but the register names no parents or cautioners. |

## Recommendation

Add William Hardie's occupation and the full published-register citation. Keep
Margaret's parentage unknown. Research the Cordiner incorporation admissions
for Hardie and Johnstoun and compare any marriage-right father or cautioner;
do not attach Margaret, Barbara and Isobel as sisters from this pattern alone.

## Recommended correction applied

Verified live **19 August 2026**: the 16 July 1611 marriage, William Hardie's
cordiner occupation and the full citation are live. Birth is an uncertain
adult-status estimate before 1595 with birthplace unknown; no parents or
sisterhood are inferred.
