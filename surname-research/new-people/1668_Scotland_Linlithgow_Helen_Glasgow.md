<!-- BEGIN FMP-GLASGOW-fmp-glasgow-8d4bf08c43ec -->
> **READY TO CREATE**

# Helen Glasgow, 22 Dec 1668

## Minimum creation fields

- **Name:** Helen Glasgow
- **Gender:** unknown
- **Birth date:** before 22 Dec 1668 (estimated from baptism)
- **Birth location:** Linlithgow, Scotland (uncertain; inferred from the person's documented event)
- **Death date:** unknown
- **Recorded event:** baptism, 22 Dec 1668
- **Recorded relationships:** father John Glasgow; mother Agnes Daston
- **Stable research ID:** `fmp-glasgow-8d4bf08c43ec`
- **Findmypast record IDs:** SCOT/OPR/BAP/0476082, SCOT/OPR/BAP/0501646
...
The 2 result ID(s) above represent one conservative documentary group because: reviewed same-person cluster: Both indexes point to page 231 of the 1668 Linlithgow register and name Helen Glasgow, daughter of John Glasgow and Agnes Easton/Daston. One supplies the 22 December baptism date and the other only the birth year; Daston is an index spelling variation, not evidence for a second child.. Preserve uncertainty; a similarly named event is not automatically the same historical person.
