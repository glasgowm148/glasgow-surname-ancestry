<!-- BEGIN FMP-GLASGOW-fmp-glasgow-e0a45e457988 -->
> **READY TO CREATE**
...
- **Name:** Edwd Glasgow
- **Gender:** unknown
- **Birth date:** before 1726 (uncertain; inferred from the person's documented event)
- **Birth location:** London, England (uncertain; inferred from the person's documented event)
- **Death date:** unknown
- **Recorded event:** Rate Books, 1726
- **Recorded relationships:** none stated in the transcript
- **Stable research ID:** `fmp-glasgow-e0a45e457988`
- **Findmypast record IDs:** GBOR/WESTMINSTER_RATEBOO/9492920/3, GBOR/WESTMINSTER_RATEBOO/9494667/3, GBOR/WESTMINSTER_RATEBOO/9497118/3
...
The 3 result ID(s) above represent one conservative documentary group because: reviewed same-person cluster: Two 1726 St Clement Danes rate-book indexes identify the same Edward or Edwd Glasgow at house 6, folio 3, including the Palsgrave Place address; the third is the adjacent house 7, folio 4 entry in the same parish and year. The evidence supports one occupier with adjacent assessments more strongly than three same-name men.. Preserve uncertainty; a similarly named event is not automatically the same historical person.
