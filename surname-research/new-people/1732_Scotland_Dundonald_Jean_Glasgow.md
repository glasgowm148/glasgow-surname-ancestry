<!-- BEGIN FMP-GLASGOW-fmp-glasgow-54571dfc429a -->
> **READY TO CREATE**

# Jean Glasgow, 01 Oct 1732

## Minimum creation fields

- **Name:** Jean Glasgow
- **Gender:** unknown
- **Birth date:** before 01 Oct 1732 (estimated from baptism)
- **Birth location:** Dundonald, Scotland (uncertain; inferred from the person's documented event)
- **Death date:** unknown
- **Recorded event:** baptism, 01 Oct 1732
- **Recorded relationships:** father William Glasgow
- **Stable research ID:** `fmp-glasgow-54571dfc429a`
- **Findmypast record IDs:** SCOT/OPR/BAP/3536699
...
'''Jean Glasgow''' was baptized on 01 Oct 1732 at Dundonald, Scotland. The record names William Glasgow as the parent. The recorded residence was Achenyeards. The father's occupation was Weaver.<ref name="FMP1" />
...
* [[Glasgow-3489|Jean]] — no exact full event-date bridge; no exact locality bridge; named record relatives do not all resolve exactly on the profile
* [[Glasgow-810|Jean]] — no exact full event-date bridge; no exact locality bridge; named record relatives do not all resolve exactly on the profile
