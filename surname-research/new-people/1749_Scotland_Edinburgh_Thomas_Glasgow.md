<!-- BEGIN FMP-GLASGOW-fmp-glasgow-37b7f7e8fed2 -->
> **READY TO CREATE**

# Thomas Glasgow, 09 Feb 1749

## Minimum creation fields

- **Name:** Thomas Glasgow
- **Gender:** unknown
- **Birth date:** 12 Jan 1749 (recorded)
- **Birth location:** Edinburgh, Scotland (uncertain; inferred from the person's documented event)
- **Death date:** unknown
- **Recorded event:** baptism, 09 Feb 1749
- **Recorded relationships:** father John Glasgow; mother Eliz Morison
- **Stable research ID:** `fmp-glasgow-37b7f7e8fed2`
- **Findmypast record IDs:** SCOT/OPR/BAP/0625636
